...
"""
    ...
    # running this script produces otherwise identical output. Use the version
    # instead, which some manpages show in bottom left.
    manpage.date = f"Version {zeekclient.__version__}"
